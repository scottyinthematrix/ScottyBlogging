...
function renderViewLink(value) {
    var url = getFullUrl(Ext.String.format('/Article/{0}', value));
    return Ext.String.format('<a href="{0}">View</a>', url);
}
...
$(document).ready(function () {
    Ext.create('Ext.grid.Panel', {
        ...
        columns: [
		    ...
		    { text: 'View', dataIndex: 'ID', renderer: renderViewLink },
		    { text: 'Edit', dataIndex: 'ID', renderer: renderEditLink }
        ],
